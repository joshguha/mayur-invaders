...
let drawText = function() {
  ...
  if (window.innerWidth >= 1200) {
    backgroundContext.fillText("MAYUR", backgroundCanvas.width - 210, backgroundCanvas.height / 2 - 20);
    backgroundContext.fillText("INVADERS", backgroundCanvas.width - 247, backgroundCanvas.height / 2 + 20);
  }
  else {
    backgroundContext.fillText("MAYUR", backgroundCanvas.width / 2 - 60, backgroundCanvas.height - 50);
